...
const testimonials = [
  {
    testimonial:
      "I thought it was impossible to make a website as beautiful as our product, but Yassine proved me wrong.",
    name: "Sara Lee",
    designation: "CFO",
    company: "Acme Co",
  ...
  {
    testimonial:
      "I've never met a web developer who truly cares about their clients' success like Yassine does.",
    name: "Chris Brown",
    designation: "COO",
    company: "DEF Corp",
  ...
  {
    testimonial:
      "After Yassine optimized our website, our traffic increased by 50%. We can't thank them enough!",
    name: "Lisa Wang",
    designation: "CTO",
